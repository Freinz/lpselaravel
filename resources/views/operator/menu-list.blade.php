...
<li class="pc-item pc-hasmenu">
    <a href="#!" class="pc-link"><span class="pc-micon">
            <i class="ph-duotone ph-identification-card"></i></span><span class="pc-mtext">Data User</span><span
            class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
    <ul class="pc-submenu">
        <li class="pc-item"><a class="pc-link" href="{{ url('lihat_profil') }}">Lihat Profil</a></li>
        <li class="pc-item"><a class="pc-link" href="{{ url('edit_profil') }}">Edit Profil</a></li>
    </ul>
</li>
