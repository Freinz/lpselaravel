                        ...
                        <div class="col-md-6">
                            <form action="{{ url('subkategori_update', $subKategori->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="exampleInputEmail1">Edit Nama Sub Kategori</label>
                                    <input type="text" class="form-control @error('subKategori') is-invalid @enderror" name="subKategori" value="{{ $subKategori->nama_subkategori }}">
                                    @error('subKategori')
