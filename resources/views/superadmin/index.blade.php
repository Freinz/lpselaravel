        ...
        <div class="card statistics-card-1">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                    <h3 class="f-w-300 d-flex align-items-center m-b-0">{{ $jumlah_user }} <small class="text-muted"></small></h3>
    ...
    <div class="col-sm-6 col-xl-4">
        <div class="card statistics-card-1">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                    <h3 class="f-w-300 d-flex align-items-center m-b-0">{{ $total_barang }} <small class="text-muted"></small></h3>
                ...
                <div class="progress" style="height: 7px">
                    <div class="progress-bar bg-brand-color-3" role="progressbar" style="width: 100%" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            </div>
        </div>
    </div>
